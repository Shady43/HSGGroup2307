...
For a detailed explanation of the functions and how the code works look into the following file: (Manual and further information.docx) 
## Manual
...
For a detailed explanation of the functions and how the code works look into the the file: (Manual and further information.docx)
